...
urlpatterns=[
    ...
    url(r'^project/addpatient$',views.project_addpatient,name='project_addpatient'),
    ...
    url(r'^patient/addtask/', views.patient_addtask, name='patient_addtask'),
    url(r'^patient/add$',views.add_patient,name='add_patient'),
    url(r'^patient/add2project$',views.patient_add2project,name='patient_add2project'),
