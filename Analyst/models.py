...
class Task(Document):
    ...
    status = StringField(null=True)
    expstatus = StringField(default='无')
    anastatus = StringField(default='无')
    jiedu_status = StringField(default='无')
    reportstatus = StringField(default='无')
    analyst= ReferenceField(User,null=True)
    jiedu=ReferenceField(User,null=True)
